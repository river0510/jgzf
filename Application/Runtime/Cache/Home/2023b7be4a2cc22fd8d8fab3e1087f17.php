		...
		<div class="content-wrap">
			<div class="container">
				...
				<div class="table-foot NoPrint" style="text-align: center">
					<a href="/jgzf/index.php/Home/Rent/form4Excel?y=<?php echo ($time['y']); ?>&w=<?php echo ($time['m']); ?>"><button
							type="submit" class="btn btn-primary" style="margin: 10px">导出excel</button></a>
				</div>
</body>
</html>