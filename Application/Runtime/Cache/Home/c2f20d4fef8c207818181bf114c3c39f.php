...
<form form method="post" action="/jgzf/index.php/Home/House/input" enctype="multipart/form-data" class="basic-grey" >
...
<b>请按下列格式进行导入</b>
<br>
<img alt="" src="/jgzf/Public/images/example.png" width="700px" height="80px">
</div>
