					...
					<div class="information"
						...
						<form action="<?php echo U('Home/Rent/modifyPersonHandle');?>" method="post"
							...
							<!-- </label> <label> <span>部门：</span> <select name="department"
								...
								onChange="getMan()">
									<?php if(($personInfo["daikoufang"]) == "工资库代扣"): ?><option selected="selected">工资库代扣</option>
										<?php else: ?>
										<option >工资库代扣</option><?php endif; ?>
									<?php if(($personInfo["daikoufang"]) == "师院代扣"): ?><option selected="selected">师院代扣</option>
										<?php else: ?>
										<option>师院代扣</option><?php endif; ?>
									<?php if(($personInfo["daikoufang"]) == "附中代扣"): ?><option selected="selected">附中代扣</option>
										<?php else: ?>
										<option>附中代扣</option><?php endif; ?>
									<?php if(($personInfo["daikoufang"]) == "银行代扣"): ?><option selected="selected">银行代扣</option>
										<?php else: ?>
										<option>银行代扣</option><?php endif; ?>
							</select>
							...
							<div class="table-foot NoPrint" style="text-align: center">
								...
								<a class="btn btn-primary" href="<?php echo U('People/peopleInfo');?>">返回</a>
							</div>
						</form>
